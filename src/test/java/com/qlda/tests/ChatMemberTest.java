...
public class ChatMemberTest extends BaseTest {
    ...
    public void setUp() throws IOException {
        ...
        MockUtils.mockUser("test2@gmail.com", "Password12345", "Member Two", false);
        super.setUp();
        ...
        projectPage.enterInviteEmail("test2@gmail.com");
        projectPage.clickInviteSubmitButton();
        projectPage.closeInvitePopup();
    }

    /**
     * Kiểm tra tab chat hiển thị đúng thành viên chat
     */
    @Test
    public void testChatTabIsDisplayed() {
        chatPage.openChatTab();
        chatPage.openMemberChat("Member Two");
        Assert.assertTrue(chatPage.isChatInputDisplayed(), "Chat input should be displayed for member chat");
    }
    ...
    /**
     * Kiểm tra gửi tin nhắn với input hợp lệ
     */
    @Test
    public void testSendMessageWithValidInput() throws InterruptedException {
        ...
        chatPage.openMemberChat("Member Two");
        chatPage.waitForPageLoad();
        chatPage.typeMessage("Hello member!");
        chatPage.clickSendButton();
        Thread.sleep(1000);
        Assert.assertTrue(chatPage.isMyMessageDisplayed("Hello member!"),
                "Sent message should be displayed in member chat");
    }
     ...
     */
    @Test
    public void testSendButtonDisabledWhenInputWhitespace_MemberChat() {
        chatPage.openChatTab();
        chatPage.openMemberChat("Member Two");
        chatPage.waitForPageLoad();
    ...
    /**
     * Kiểm tra gửi tin nhắn với độ dài tối thiểu
     * @throws InterruptedException
     */
    @Test
    public void testSendMessageWithMinLength_MemberChat() throws InterruptedException {
        chatPage.openChatTab();
        chatPage.openMemberChat("Member Two");
        chatPage.waitForPageLoad();
        String minMessage = "a";
        ...
        chatPage.clickSendButton();
        Thread.sleep(1000);
        Assert.assertTrue(chatPage.isMyMessageDisplayed(minMessage), "Sent message should be displayed in member chat");
    }

    /**
     * Kiểm tra gửi tin nhắn với độ dài tối đa
     * @throws InterruptedException
     */
    @Test
    public void testSendMessageWithMaxLength_MemberChat() throws InterruptedException {
        chatPage.openChatTab();
        chatPage.openMemberChat("Member Two");
        chatPage.waitForPageLoad();
        ...
        chatPage.clickSendButton();
        Thread.sleep(1000);
        Assert.assertTrue(chatPage.isMyMessageDisplayed(maxMessage), "Sent message should be displayed in member chat");
    }
     ...
     */
    @Test
    public void testSendMessageWithSpecialCharacters_MemberChat() throws InterruptedException {
        chatPage.openChatTab();
        chatPage.openMemberChat("Member Two");
        chatPage.waitForPageLoad();
        ...
        Assert.assertTrue(chatPage.isMyMessageDisplayed(specialMessage),
                "Special character message should be displayed in member chat");
    }
     ...
     */
    @Test
    public void testSendMessageWithVietnameseCharacters_MemberChat() throws InterruptedException {
        chatPage.openChatTab();
        chatPage.openMemberChat("Member Two");
        chatPage.waitForPageLoad();
        ...
        Assert.assertTrue(chatPage.isMyMessageDisplayed(vietnameseMessage),
                "Vietnamese message should be displayed in member chat");
    }
     ...
     */
    @Test
    public void testSendMessageWithUnicodeCharacters_MemberChat() throws InterruptedException {
        chatPage.openChatTab();
        chatPage.openMemberChat("Member Two");
        chatPage.waitForPageLoad();
        ...
        chatPage.clickSendButton();
        Thread.sleep(1000);
        Assert.assertTrue(chatPage.isMyMessageDisplayed(message), "Unicode message should be displayed in member chat");
    }
     ...
     */
    @Test
    public void testSendMessageWithEmoji_MemberChat() throws InterruptedException {
        chatPage.openChatTab();
        chatPage.openMemberChat("Member Two");
        chatPage.waitForPageLoad();
        ...
        chatPage.clickSendButton();
        Thread.sleep(1000);
        Assert.assertTrue(chatPage.isMyMessageDisplayed(emojiMessage),
                "Emoji message should be displayed in member chat");
    }
     ...
     */
    @Test
    public void testSendMessageWithHtmlTags_MemberChat() throws InterruptedException {
        chatPage.openChatTab();
        chatPage.openMemberChat("Member Two");
        chatPage.waitForPageLoad();
        ...
        chatPage.clickSendButton();
        Thread.sleep(1000);
        Assert.assertTrue(chatPage.isMyMessageDisplayed(htmlMessage),
                "HTML tag message should be displayed in member chat");
    }
     ...
     */
    @Test
    public void testSendMessageWithLeadingAndTrailingSpaces_MemberChat() throws InterruptedException {
        chatPage.openChatTab();
        chatPage.openMemberChat("Member Two");
        chatPage.waitForPageLoad();
        ...
        Assert.assertTrue(chatPage.isMyMessageDisplayed(spacedMessage),
                "Message with leading and trailing spaces should be displayed in member chat");
    }

    /**
     * Kiểm tra tin nhắn realtime trong member chat
     * @throws Exception
     */
    @Test
    public void testMemberChatRealtimeDisplay() throws Exception {
        ...
        // User1 gửi tin nhắn cho test2 (member chat)
        chatPage.openChatTab();
        chatPage.openMemberChat("Member Two"); // hoặc "Member Two" tùy tên hiển thị
        String realtimeMessage = "Tin nhắn member realtime";
        chatPage.typeMessage(realtimeMessage);
        chatPage.clickSendButton();

        // Tạo driver/session mới cho test2
        ...
        loginPage2.loginUser("test2@gmail.com", "Password12345");
        ProjectPage projectPage2 = new ProjectPage(driver2, wait2);
        projectPage2.waitForPageLoad();
        driver2.get(projectUrl);

        // test2 mở member chat với User1
        ChatPage chatPage2 = new ChatPage(driver2, wait2);
        chatPage2.openChatTab();
        chatPage2.openMemberChat("Valid User"); // hoặc "test@gmail.com" tùy tên hiển thị

        // test2 kiểm tra tin nhắn xuất hiện ngay lập tức
        ...
        Assert.assertTrue(received, "test2 phải thấy tin nhắn realtime từ User1 trong member chat");

        driver2.quit();
    }

    /**
     * Kiểm tra lịch sử tin nhắn trong member chat sau khi đăng nhập lại
     * @throws Exception
     */
    @Test
    public void testMemberChatHistoryAfterRelogin() throws Exception {
        String projectUrl = driver.getCurrentUrl();
        projectPage.logout();
        loginPage.loginUser("test@gmail.com", "Password12345");
        projectPage.waitForPageLoad();
        ...
        // Gửi tin nhắn member chat
        chatPage.openChatTab();
        chatPage.openMemberChat("Member Two");
        String message = "Tin nhắn kiểm tra lịch sử member chat";
        chatPage.typeMessage(message);
        chatPage.clickSendButton();
        Thread.sleep(1000);
        ...
        Assert.assertTrue(chatPage.isMyMessageDisplayed(message),
                "Tin nhắn phải còn trong lịch sử member chat sau khi đăng nhập lại");
    }
